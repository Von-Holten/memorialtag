...
<article class="info">
					...
					<tr>
						<td><asp:TextBox class="edit" ID="txtFornavn" MaxLength="50" Name="given name" runat="server"></asp:TextBox></td>
						<td><asp:TextBox class="edit" ID="txtEfternavn" MaxLength="50" Name="family name" runat="server"></asp:TextBox></td>
					</tr>
					<tr>
						<th>Fødselsdato:</th>
						<th>Dødsdato:</th>
					...
					<tr>
						<td><asp:TextBox class="edit" ID="txtFødeby" MaxLength="50" runat="server"></asp:TextBox></td>
						<td><asp:TextBox class="edit" ID="txtSidsteBopæl" MaxLength="50" runat="server"></asp:TextBox></td>
					</tr>
					<tr>
						<th>Stilling:</th>
					...
					<tr>
						<td><asp:TextBox class="edit" ID="txtStilling" MaxLength="50" runat="server"></asp:TextBox></td>
						<td><asp:TextBox class="edit" ID="txtNærmestePårørende" MaxLength="100" runat="server"></asp:TextBox></td>
					</tr>
                    <tr>
						<th>Facebook Link:</th>
                    ...
                    <tr>
						<td><asp:TextBox class="edit" ID="txtFacebookLink" MaxLength="100" runat="server"/></td>
                        <td><asp:TextBox class="edit" ID="txtMyHeritageLink" MaxLength="100" runat="server"/></td>
					</tr>
					</table>
					<br/>
            </article>
